      ...
      <Tab.Navigator
        ...
        screenOptions={({route}) => ({
          tabBarIcon: ({focused}) => {
            ...
            return <Image tintColor={"#000"} style={palette.header.image} source={iconName} />;
          },
        })}>
        ...
        <Tab.Screen name="AddPost" component={addPostNavigator} options={{
          headerShown: false, 
        }}/>
        <Tab.Screen name="Activity" component={activityNavigator} options={{
          headerShown: false,
        }}/>
